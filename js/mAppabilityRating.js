...
let data = [{ label:0, radius:2.5, color:'#ffffff' },
            { label:1, radius:2.5, color:'#eeff00' },
            { label:2, radius:2.5,color:'#ff0022' },
            { label:3, radius:2.5 , color:'#3300ff'},
            { label:4, radius:2.5,  color:'#30ffff' }]
